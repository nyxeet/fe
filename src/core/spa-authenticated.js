...
import LearnContext from "../routes/learn-context";
...
const ROUTES = {
  ...
  greetDetail: { component: <GreetDetail /> },
  cards: { component: <Cards /> },
  helloWorld: { component: <HelloWorld /> },
  learnContext: { component: <LearnContext /> },
  categoryDetails: { component: <CategoryDetails /> },

const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuTest",
      en: "About application uuTest",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuTest.",
      en: "You can buy your own uuTest.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuTest.",
      en: "You don't have rights to initialize this uuTest.",
    },
  },
